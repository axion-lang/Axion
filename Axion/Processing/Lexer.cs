        ...
        private static Token MakeNextToken() {
            while (true) {
                ...
                // number
                    ...
                    var numValue = char.IsDigit(numStr[numStr.Length - 1])
                                       ? numStr
                    ...
                    #region Integer
                        ...
                        if (numStr.EndsWith("s") &&
                            ...
                            return new NumberToken(
                                NumberType.Int16, int16.ToString(),
                                lnI, startCl
                            );
                        }
                        // integer
                        if (numStr == numValue &&
                            ...
                            return new NumberToken(
                                NumberType.Int32, int32.ToString(),
                                lnI, startCl
                            );
                        }
                        // long int
                        if (long.TryParse(numValue, out var int64)) {
                            return new NumberToken(
                                NumberType.Int64, int64.ToString(),
                                lnI, startCl
                            );
                        }
                    }
                ...
                // identifier
                    ...
                    if (Specification.BoolOperators.Contains(word)) {
                        id = TokenID.Operator;
                    }
                    else if (Specification.BuiltInTypes.Contains(word)) {
                        id = TokenID.BuiltIn;
                    }
                    else if (Specification.Keywords.Contains(word)) {
                        id = TokenID.Keyword;
                    }
                    else {
                ...
                // operator
                    ...
                    if (Specification.Operators.TryGetValue(op, out var @operator)) {
