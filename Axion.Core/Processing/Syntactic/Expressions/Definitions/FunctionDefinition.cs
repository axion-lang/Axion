...
namespace Axion.Core.Processing.Syntactic.Expressions.Definitions {
    ...
    public class FunctionDefinition : Expression, IDecorable, IFunctionNode {
        ...
        /// </summary>
        internal FunctionDefinition(AstNode parent) : base(parent) {
            MarkStartAndEat(KeywordFn);
        ...
        /// </summary>
        internal FunctionDefinition(AstNode parent, MethodDeclarationSyntax csNode) : base(parent) {
